        ...
        {enrollments.length === 0 ? (
          ...
          <div className="space-y-4">
            {enrollments.map((en) => {
              ...
              return (
                <div key={en.id} className="bg-white rounded-xl border border-gray-200 overflow-hidden hover:shadow-sm transition-shadow">
                  <div className="flex flex-col sm:flex-row">
                    ...
                    <div className="flex-1 p-5">
                      ...
                      {payMsg[en.course_id] && (
                        <p className="text-xs mt-2 text-green-600">{payMsg[en.course_id]}</p>
                      )}
                    </div>
                  </div>
                </div>
